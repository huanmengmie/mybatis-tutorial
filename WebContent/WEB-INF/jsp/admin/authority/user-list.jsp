				...
				success:function(data){
			        ...
			        if(data.length>0){
			        		...
			        		$.each(data,function(idx,item){ 
			        			...
			        			xhtml+="<td>"+item.roleName+"</td><td><img src='"+CTP_HOME+"/image/assign.png'/><a href='javascript:void(0);' class='only-select'>选择角色</a></td></tr>";
				...
				<div class="a-content">
					<table>
						...
						<tr>
							...
							<td><img src="${CTP_ADMIN }/image/assign.png"/><a href="javascript:void(0);" class="only-select">选择角色</a></td>
						</tr>
				        </c:forEach>
					</table>
					<!-- 分页 -->
