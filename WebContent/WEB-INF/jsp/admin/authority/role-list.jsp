	              ...
	              layer.confirm('确定删除所选择的记录？', {
	      			  btn: ['确定','取消'] 
	      				...
	      				$.ajax({
							type:'post',
							dataType:'json',
							url:CTPPATH+"/admin/authority/deleteRole",
							data:{"ids":ids},
						...
						success:function(data){
					        ...
					        if(data.length>0){
					        		...
					        		$.each(data,function(idx,item){ 
					        			...
					        			xhtml+="<tr><td> <input type='checkbox' name='info_id' value="+item.id+"></td><td>"+item.roleName+"</td><td>"+item.roleCode+"</td><td><img src='"+CTP_HOME+"/image/delete.png'/><a href='javascript:void(0);' class='only-delete'>删除</a></td></tr>";
				...
				<div class="a-content">
					<table>
						...
						<tr>
							...
							<td><img src="${CTP_ADMIN }/image/delete.png"/><a href="javascript:void(0);" class="only-delete">删除</a></td>
						</tr>
						</c:forEach>
					</table>
